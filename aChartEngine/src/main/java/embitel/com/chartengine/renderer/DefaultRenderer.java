...
public class DefaultRenderer implements Serializable {
  ...
  /** The showUserYGrid to display user specified grid.
   * User specified grid is define by using inner class  userYGrid
   * and added with addUserYGrid(userYGrid)
   * default value: false
   */
  private boolean showUserYGrid = false;



  private List<UserYGrid> mUserYGrid;

  /** Set to true to display user specified grids
   * if they ared defined.
   * User specified grid should be defined by using inner class  userYGrid
   * and added with addUserYGrid(userYGrid)
   * default value: false
   */
  public void setShowUserYGrid(boolean showUserYGrid) {
    this.showUserYGrid = showUserYGrid;
  }
   ...
   * default value: false
   */
  public boolean isShowUserYGrid() {
    return showUserYGrid;
  }

  /** The user specified grids is define by a list of userYGrid
   * you may want to use add grid using addUserYGrid(userYGrid)
   */
  public void setUserYGrid(List<UserYGrid> mUserYGrid) {
    this.mUserYGrid = mUserYGrid;
  }

  /** The user specified grids is define by a list of userYGrid
   * you may want to use add grid using addUserYGrid(userYGrid)
   */
  public List<UserYGrid> getUserYGrid() {
    return mUserYGrid;
  }

  /** The user specified grids is define by a list of userYGrid
   *  add another grid using addUserYGrid(userYGrid)
   */
  public void addUserYGrid(UserYGrid userYGrid) {
    if (this.mUserYGrid==null)
      this.mUserYGrid= new  ArrayList<UserYGrid>();
    this.mUserYGrid.add(userYGrid);
  }
