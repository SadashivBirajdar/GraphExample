...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
  ...
  /** A flag for enabling path effect for horizontal lines. */
  private boolean mXPathEffect=false;
  ...
  /**
   * Sets the pathEffect for horizontal lines.
   *
   * @param pathEffect the approximate number of labels for the X axis
   */
  public void setGridXPathEffect(boolean pathEffect) {
    mXPathEffect = pathEffect;
  }

  public boolean isXPathEffect() {
    return mXPathEffect;
  }
